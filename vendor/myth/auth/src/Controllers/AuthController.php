...
class AuthController extends Controller
{
    ...
    public function login()
    {
        ...
        return $this->_render($this->config->views['login'], ['config' => $this->config, 'title' => 'Masuk SIMABA | Mahasiswa']);
    }
    ...
    public function register()
    {
        ...
        return $this->_render($this->config->views['register'], ['config' => $this->config, 'title' => 'Daftar Akun SIMABA | Mahasiswa']);
    }
    ...
    {
        // dd($this->request->getPost('group_id'));
        ...
        $users->withGroup($this->request->getPost('group_id'));
