            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="index.html"><?php if (in_groups('mahasiswa')) : ?>MAHASISWA<?php endif; ?><?php if (in_groups('superadmin')) : ?>SUPERADMIN<?php endif; ?><?php if (in_groups('admin')) : ?>ADMIN<?php endif; ?></a>
                    </div>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <?php if (in_groups('mahasiswa')) : ?>
                            ...
                            <li class="<?= ($title == "Daftar Mahasiswa") ? 'active' : '' ?>"><a class="nav-link" href="blank.html"><i class="far fa-square"></i> <span>Daftar Mahasiswa</span></a></li>
                        <?php endif; ?>
                        ...
                        <?php if (in_groups('superadmin')) : ?>
                            <li class="<?= ($title == "Admin") ? 'active' : '' ?>"><a class="nav-link" href="blank.html"><i class="far fa-square"></i> <span>Admin</span></a></li>
                        <?php endif; ?>
                        <li><a class="nav-link" href="blank.html"><i class="far fa-square"></i> <span>Lougout</span></a></li>
                    </ul>
                </aside>
            </div>
